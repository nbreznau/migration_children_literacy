...
This data package contains the data that powers the chart ["Share of the population that were born in another country"](https://ourworldindata.org/grapher/migrant-stock-share?tab=line&country=JPN~Western+Europe+%28UN%29~OWID_NAM~OWID_AFR~OWID_ASI~OWID_OCE~OWID_SAM~OWID_EUR~OWID_WRL&mapSelect=~JPN&overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on December 31, 2025.

### Active Filters

A filtered subset of the full data was downloaded. The following filters were applied:
country: JPN, Western Europe (UN), OWID_NAM, OWID_AFR, OWID_ASI, OWID_OCE, OWID_SAM, OWID_EUR, OWID_WRL
tab: line
