...
This data package contains the data that powers the chart ["Total number of emigrants"](https://ourworldindata.org/explorers/migration?tab=table&facet=none&tableFilter=continents&overlay=download-data&hideControls=false&Metric=Number+of+international+immigrants&Period=Total&country=USA~DEU~FRA~GBR~SYR~TUR~YEM~IND~CAN) on the Our World in Data website. It was downloaded on December 23, 2025.

### Active Filters

A filtered subset of the full data was downloaded. The following filters were applied:
country: USA, DEU, FRA, GBR, SYR, TUR, YEM, IND, CAN
tab: table
